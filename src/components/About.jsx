        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="relative">
            ...
            <p className="relative z-10 text-xl font-light leading-relaxed text-slate-600 dark:text-slate-300 mb-8">
              Motivated MERN Stack Developer with hands-on experience building scalable full-stack web applications using MongoDB, Express.js, React.js, and Node.js. Experienced in developing RESTful APIs, implementing secure JWT authentication, and creating responsive, user-friendly interfaces with modern JavaScript (ES6+). Passionate about solving real-world problems and continuously learning new technologies to build efficient and high-quality web applications.
            </p>
